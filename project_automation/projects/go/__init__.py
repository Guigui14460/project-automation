...
from .golang import GolangProject
...
class ParserGolang(Parser):
    """
    Parser class to add subcommand for Golang projects.
    ...
    def modify_project_settings(self, result: argparse.Namespace, project_settings: dict) -> dict:
        ...
        """
        project_settings['klass'] = GolangProject
