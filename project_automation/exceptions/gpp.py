...
class CPPCommandNotExists(CommandNotExistsError):
    """
    Raised when the `g++` command does not recognized by the system.
    ...
    def __init__(self, allow_install: bool = False) -> NoReturn:
        ...
        allow_install : bool
            True if you want to automatically install the required packages, False otherwise
        """
        super().__init__('g++', allow_install=allow_install, windows_installation="https://osdn.net/projects/mingw/releases/",
